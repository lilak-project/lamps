...
bool LHPadPlaneYCut::Init()
{
    ...
    for (int layer=0; layer<fNumLayers; ++layer)
    {
        ...
        for (int iRow=1; isInnerPad; ++iRow)
        {
            ...
            if (yPad-fPadHeight*0.2 > fRTopCut) {
            ...
            xCorner[0] = xPad + .5*fPadWidth; yCornerTemp = sqrt(radius2*radius2-xCorner[0]*xCorner[0]); if (yCornerTemp>fRTopCut) yCornerTemp=fRTopCut; yCorner[0] = yCornerTemp;
            xCorner[1] = xPad - .5*fPadWidth; yCornerTemp = sqrt(radius2*radius2-xCorner[1]*xCorner[1]); if (yCornerTemp>fRTopCut) yCornerTemp=fRTopCut; yCorner[1] = yCornerTemp;
            xCorner[2] = xPad - .5*fPadWidth; yCornerTemp = sqrt(radius1*radius1-xCorner[2]*xCorner[2]); if (yCornerTemp>fRTopCut) yCornerTemp=fRTopCut; yCorner[2] = yCornerTemp;
            xCorner[3] = xPad + .5*fPadWidth; yCornerTemp = sqrt(radius1*radius1-xCorner[3]*xCorner[3]); if (yCornerTemp>fRTopCut) yCornerTemp=fRTopCut; yCorner[3] = yCornerTemp;
