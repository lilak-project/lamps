...
class LTPadPlane : public LKDetectorPlane, public LKPadInteractive
{
    public:
        LTPadPlane();
        virtual ~LTPadPlane() {}
        ...
        void ClickedPad2DEvent(double xOnClick, double yOnClick);
        void ClickedPadSection(double xOnClick, double yOnClick);
        void ClickedPadCtrlEv1(double xOnClick, double yOnClick);
        void ClickedPadCtrlEv2(double xOnClick, double yOnClick);
        ...
        void SelectAndDrawChannel(Double_t x, Double_t y);
